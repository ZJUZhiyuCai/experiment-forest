...
export function ExcelTable({ 
  ...
  return (
    <div className="fixed inset-0 bg-black bg-opacity-50 flex items-center justify-center z-50 p-4">
      <div className="bg-white dark:bg-gray-800 rounded-xl shadow-lg w-full max-w-6xl max-h-[90vh] overflow-hidden flex flex-col">
        <div className="p-6 border-b border-gray-200 dark:border-gray-700">
          <div className="flex justify-between items-center mb-4">
            <div>
              <h3 className="text-xl font-bold text-gray-800 dark:text-white">
                <i className="fa-solid fa-table mr-2 text-emerald-600"></i>
                高级表格编辑器
              </h3>
              ...
              <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
                {Object.entries(EXPERIMENT_TEMPLATES).map(([key, template]) => (
                  <button
                    ...
                    className="p-4 border border-gray-200 dark:border-gray-700 rounded-lg hover:border-emerald-300 hover:bg-emerald-50 dark:hover:bg-emerald-900/20 transition-all text-left group"
                  >
                    <div className="flex items-center mb-2">
                      <i className={`fa-solid ${template.icon} text-2xl text-emerald-600 mr-3`}></i>
                      <h5 className="font-semibold text-gray-800 dark:text-white group-hover:text-emerald-600">
                        {template.name}
                      </h5>
                    </div>
            ...
            <div>
              ...
              <div className="mb-6 bg-gray-50 dark:bg-gray-900/50 rounded-lg p-4">
                <div className="flex flex-wrap gap-4 items-center justify-between">
                  ...
                  <div className="text-sm text-gray-500 dark:text-gray-400 bg-emerald-50 dark:bg-emerald-900/20 px-3 py-2 rounded-lg">
                          ...
                          {row.map((cell, colIndex) => (
                            <td key={colIndex} className="border-r border-gray-200 dark:border-gray-700 last:border-r-0">
                              <input
                                ...
                                className={`w-full h-full px-3 py-2 text-sm border-0 focus:ring-2 focus:ring-emerald-500 bg-transparent transition-all ${
                                  selectedCell?.row === rowIndex && selectedCell?.col === colIndex 
                                    ? 'bg-emerald-50 dark:bg-emerald-900/20' 
                                    : 'hover:bg-gray-50 dark:hover:bg-gray-700/30'
                                } min-w-[120px] ${
                                  tableStyle.hasHeader && rowIndex === 0 
                ...
                <div className="grid grid-cols-3 gap-2">
                  {[
                    ...
                    <button
                      ...
                      className={`p-3 rounded-md text-sm border transition-all text-center ${
                        tableStyle.borderStyle === style.key
                          ? 'bg-emerald-100 border-emerald-300 text-emerald-700'
                          : 'bg-gray-50 border-gray-200 text-gray-700 hover:bg-gray-100'
                      }`}
                    >
