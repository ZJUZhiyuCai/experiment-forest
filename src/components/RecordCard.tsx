      ...
      <div className="p-5">
        <div className="flex justify-between items-start mb-3">
          <div>
            ...
            <div className="mt-2 flex flex-wrap gap-2">
              ...
              <span className={`inline-block px-2 py-0.5 text-xs rounded-full ${record.category === 'cell_culture' ? 'bg-emerald-100 text-emerald-800 dark:bg-emerald-900/30 dark:text-emerald-400' :
        ...
        <div className="flex flex-wrap gap-2 mb-4">
          {record.tags.map((tag, index) => (
            <span
              key={index}
              className="px-2 py-1 bg-forest-light text-text-main text-xs rounded-full"
            >
              {tag}
            </span>
          ))}
