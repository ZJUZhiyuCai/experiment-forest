...
export default function Notes() {
  ...
  return (
    <div className="min-h-screen bg-[#F9F6F2] text-[#555555]" ref={performanceRef}>
                ...
                <form onSubmit={handleSubmit} className="space-y-6">
                  <div>
                    ...
                    <input
                      ...
                      className={`w-full px-4 py-2 rounded-lg border focus:outline-none focus:ring-2 focus:ring-emerald-500 transition-colors ${
                        errors.title 
          ...
          <div className="mb-6">
            <div className="relative">
              <input
                type="text"
                placeholder="搜索实验笔记..."
                className="w-full pl-10 pr-4 py-3 rounded-lg border border-gray-300 bg-white focus:outline-none focus:ring-2 focus:ring-emerald-500 focus:border-emerald-500"
                value={searchQuery}
          ...
          {loading ? (
            ...
            <div className="text-center py-12">
              <div className="w-24 h-24 bg-gray-100 rounded-full flex items-center justify-center mx-auto mb-4">
                <i className="fa-solid fa-sticky-note text-3xl text-gray-400"></i>
              </div>
